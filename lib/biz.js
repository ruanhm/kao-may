...
class Biz {
    constructor(bizName, checks, sqls, type, isSys, isMetaCache, params, countSql, hiddenFields, scenes, readOnly4Adds, readOnly4Edits, notNulls) {
        ...
        if (!_.isWeakSet(params)) throw new Error('Type Error:params is a WeakSet');
...
class BizRun extends Biz {
    static async execQuery() { }
    static async execOeration() { }
...
class BizManage extends Biz {
    ...
    static async exportBiz(biz) { 
        
    }

}
module.exports.Biz = Biz;
module.exports.BizRun = BizRun;
